...
myTerminal :: String
myTerminal = "xfce4-terminal"        -- Default terminal
...
myKeys =
    ...
    -- Scratchpad windows
      ...
      , ("M-a", namedScratchpadAction myScratchPads "thunar")                 -- Nautilus
...
myManageHook = composeAll
     ...
     --, className =? "Xfce4-notifyd-config"              --> doIgnore
